...
deck:
	...
	$(PY) deck/fix_package.py ML_Bubble_2026_Presentation_Deck.pptx
	$(PY) deck/qa_deck.py ML_Bubble_2026_Presentation_Deck.pptx
	$(PY) deck/preview.py ML_Bubble_2026_Presentation_Deck.pptx
